...
const EbayHeader = ({ hideNavItems = false }) => {
                ...
                <header data-marko-key="@gh s0-1-4" id="gh" className="gh-header">
                    ...
                    <div className="gh-header__top-container">
                        <nav className="gh-nav">
                            <div className="gh-container flex justify-between">
                                ...
                                <div className="gh-nav__right-wrap">
                                    ...
                                    <div className="gh-flyout is-right-aligned gh-watchlist">
                                        ...
                                        <div className="gh-flyout__dialog" id="s0-1-4-8-12-0-0-dialog" style={{ display: isWatchlistFlyoutOpen ? 'block' : 'none' }}>
                                            <div className="gh-flyout__box !p-0 !min-w-[400px]">
                                                <div className="gh-watchlist-flyout bg-white rounded-lg shadow-xl overflow-hidden">
                                                    <Link href="/ebay/mye/myebay/watchlist" className="block p-4 border-b border-gray-100 hover:bg-gray-50 group flex items-center justify-between no-underline">
                                                        <span className="text-lg font-bold text-[#191919]">View all items you are watching</span>
                                                    ...
                                                    {watchlistItems.length === 0 ? (
                                                        <div className="p-8 text-center">
                                                            <p className="text-[#707070] mb-4">You're not watching any items yet.</p>
                                                            <Link href="/ebay" className="text-[#3665f3] hover:underline font-bold">Start shopping</Link>
                                                        </div>
                                                    ) : (
                                                        <div className="p-4 grid grid-cols-2 gap-4 max-h-[500px] overflow-y-auto">
                                                            {watchlistItems.slice(0, 4).map((item) => (
                                                                <div key={item.id} className="flex flex-col group/item relative">
                                                                    <Link href={`/ebay/itm/${item.id}`} className="block aspect-square bg-white rounded-lg border border-gray-100 mb-2 overflow-hidden flex items-center justify-center relative">
                                                                        <img src={item.image} alt="" className="w-full h-full object-contain p-2" />
                                                                    </Link>
                                                                    <Link href={`/ebay/itm/${item.id}`} className="text-sm text-[#191919] hover:underline line-clamp-2 leading-snug mb-2 flex-grow no-underline">
                                                                        {item.title}
                                                                    </Link>
                                                                    <div className="space-y-0.5">
                                                                        <div className="font-bold text-base text-[#191919]">
                                                                            RMB {(item.price * 7.1).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                                                        </div>
                                                                        <div className="text-[12px] text-[#707070]">
                                                                            + RMB 43.59 Shipping
                                                                        </div>
                                                                        <div className="text-[12px] font-bold text-[#dd1e31]">
                                                                            8163 sold
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            {watchlistItems.length > 4 && (
                                                                <div className="col-span-2 text-center pt-2">
                                                                    <Link href="/ebay/mye/myebay/watchlist" className="text-[#3665f3] font-bold py-2 px-4 rounded-full border border-[#3665f3] hover:bg-blue-50 transition-colors inline-block no-underline text-sm">
                                                                        See {watchlistItems.length - 4} more items
                                                                    </Link>
                                                                </div>
                                                            )}
                                                        </div>
                                            ...
                                            <div className="gh-flyout__box">
                                                <ul className="gh-my-ebay__list">
                                                    <li className="gh-my-ebay__list-item">
                                                        <Link href="/ebay/myebay">Summary</Link>
                                                    </li>
                                                    <li className="gh-my-ebay__list-item">
                                                        <Link href="/ebay/myebay">Recently Viewed</Link>
                                                    </li>
                                                    <li className="gh-my-ebay__list-item">
                                            ...
                                            <div className="gh-flyout__dialog" id="s0-1-4-8-14-0-1-dialog" style={{ display: isNotificationsFlyoutOpen ? 'block' : 'none' }}>
                                                <div className="gh-flyout__box">
                                                    <div className="gh-notifications__dialog gh-notifications--loaded">
                                                        ...
                                                        <div className="gh-notifications__loaded">
                                    ...
                                    <div className="gh-cart">
                                        <Link href="/ebay/cart" className="gh-eb-li-a text-[#191919] relative inline-block" aria-label="Your shopping cart">
                                            <svg className="icon icon--24" focusable="false" aria-hidden="true" style={{ width: '24px', height: '24px' }}>
                                                <use href="#icon-cart-24"></use>
                                            </svg>
                                            {cartCount > 0 && (
                                                <span className="gh-cart-icon__badge bg-[#ff0000] text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center absolute top-[-5px] right-[-5px] font-bold transition-all animate-in fade-in zoom-in duration-300">
                                                    {cartCount}
                                                </span>
                                            )}
                                        </Link>
                        ...
                        <svg style={{ display: 'none' }} aria-hidden="true">
                            <defs>
                                ...
                                <symbol id="icon-cart-24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
